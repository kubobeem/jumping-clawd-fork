...
export const COMPETITIVE_MODE_CHARGE_INITIAL_SPEED_MULTIPLIER = 2;
export const COMPETITIVE_MODE_DRIFT_INITIAL_SPEED_RATIO = 0.2;
export const COMPETITIVE_MODE_DRIFT_ACCELERATION_RATIO = 0.006;
export const COMPETITIVE_MODE_DRIFT_ACCELERATION_GROWTH_RATIO = 0.0012;
export const COMPETITIVE_MODE_DRIFT_MAX_SPEED_RATIO = 0.52;
...
export const BOTTOM_DEATH_EMBED_DEPTH_RATIO = 0.22;
export const BOTTOM_DEATH_EMBED_DEPTH_MIN = 5;
export const BOTTOM_DEATH_EMBED_DEPTH_MAX = 12;
...
export const COMPETITIVE_CURRENT_SURFACE_RATIO = 0.24;
...
export const COMPETITIVE_TARGET_HORIZONTAL_DISTANCE_MIN_RATIO = 0.22;
export const COMPETITIVE_TARGET_HORIZONTAL_DISTANCE_MAX_RATIO = 0.54;
export const COMPETITIVE_TARGET_VERTICAL_GAP_MIN_RATIO = 0.4;
export const COMPETITIVE_TARGET_VERTICAL_GAP_MAX_RATIO = 0.52;
