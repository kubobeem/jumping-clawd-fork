...
export const CHALLENGE_MODE_DRIFT_ACCELERATION_RATIO = 0.006;
export const CHALLENGE_MODE_DRIFT_ACCELERATION_GROWTH_RATIO = 0.0012;
export const CHALLENGE_MODE_DRIFT_MAX_SPEED_RATIO = 0.52;
...
export const CHALLENGE_TARGET_VERTICAL_GAP_MIN_RATIO = 0.4;
